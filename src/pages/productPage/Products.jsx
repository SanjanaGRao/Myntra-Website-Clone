    ...
    <>
      ...
      <div className="box">
        { products.length !== 0 ? (
          <>
            <div className="topText">
              ...
              <span><b>{products[0].attributes.category}</b></span>
            </div>
            <div className="secondText">
              <span className="secondTextTitle"><b>{products[0].attributes.category}</b></span>
              <span className="grey">
                {' '}
                -
                {' '}
        ...
        { products.length !== 0 ? (products.map((item) => (
          <Grid item xs={10} md={2.75} style={{ paddingTop: '2.5em', display: 'inline-block', paddingLeft: '6.5em' }}>
