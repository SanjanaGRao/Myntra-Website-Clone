  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <br />
        <Divider />
        <MenuBold>{" "}Orders{" "}</MenuBold>
        <MenuBold>{" "}Wishlist{" "}</MenuBold>
        <MenuBold>{" "}Gift Cards{" "}</MenuBold>
        <MenuBold>{" "}Contact Us{" "}</MenuBold>
        <MenuBold>
          {" "}
          Myntra Insider &nbsp;&nbsp;
        ...
        <Divider />
        <MenuBold>{" "}Myntra Credit{" "}</MenuBold>
        <MenuBold>{" "}Coupons{" "}</MenuBold>
        <MenuBold>{" "}Saved Cards{" "}</MenuBold>
        <MenuBold>{" "}Saved Addresses{" "}</MenuBold>
      </Menu>
    </React.Fragment>
  );
}
